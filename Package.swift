...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AWSKinesis",
            url: "https://github.com/cricut/aws-sdk-ios/releases/download/2.18.0_small/AWSKinesis.xcframework.zip",
            checksum: Checksums.kinesis.rawValue
        ),
        .binaryTarget(
            name: "AWSCore",
            url: "https://github.com/cricut/aws-sdk-ios/releases/download/2.18.0_small/AWSCore.xcframework.zip",
